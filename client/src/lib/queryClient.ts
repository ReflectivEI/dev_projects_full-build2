...
// Priority: window.WORKER_URL (runtime override) -> VITE_WORKER_URL (build-time) -> VITE_API_BASE_URL (legacy) -> fallback to production worker
const RUNTIME_BASE =
...
// Log the chosen API base URL once at startup
