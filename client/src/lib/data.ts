...
export const signalCapabilities: SignalCapability[] = [
  {
    ...
    category: 'awareness',
    description: 'Balance of open vs. closed questions, relevance to customer goals, logical sequencing, and follow-up depth.',
    showsUpWhen: 'Often shows up when a seller asks purposeful, well-sequenced questions that build on customer responses.',
    examples: [
    ...
    calculation: 'WEIGHTED_AVG(open_closed_ratio, relevance_to_goals, sequencing_logic, follow_up_depth)',
    sampleIndicators: [
      'Uses "how", "what", "why" to open dialogue',
      'References customer-stated goals',
      'Uses transitions between topics',
    ...
    keyTip: 'Ask more open-ended questions that connect to what the customer has already shared.',
    icon: 'Target',
  ...
  },
  {
    ...
    description: 'Reflects back customer statements, acknowledges concerns when raised, and adapts approach when customer shares new information.',
    showsUpWhen: 'Often shows up when a seller paraphrases, validates concerns, and incorporates new details into the discussion.',
    examples: [
      'Uses "what I\'m hearing is..."',
      'Says "I hear you" or "I understand"',
      'Incorporates new details into discussion',
    ],
    calculation: 'AVG(paraphrasing, acknowledgment_of_concerns, adjustment_to_new_info)',
    sampleIndicators: [
      'Uses "what I\'m hearing is..."',
      'Says "I hear you" or "I understand"',
      'Incorporates new details into discussion',
    ],
    keyTip: 'Paraphrase what you hear and acknowledge concerns before responding.',
    icon: 'Ear',
    color: 'hsl(142, 76%, 36%)',
    isCore: true,
  },
  {
    ...
    category: 'engagement',
    description: 'Focuses on outcomes and results, ties value proposition to customer-stated priorities, and avoids overwhelming with feature lists.',
    showsUpWhen: 'Often shows up when a seller connects features to benefits and uses customer language.',
    examples: [
      'Uses "so that", "which means", "so you can"',
      'References customer goals in pitch',
      'Presents features selectively',
    ],
    calculation: 'WEIGHTED_AVG(outcome_based_language, link_to_customer_priorities, no_feature_dumping)',
    sampleIndicators: [
      'Uses "so that", "which means", "so you can"',
      'References customer goals in pitch',
      'Presents features selectively',
    ],
    keyTip: 'Connect every feature to an outcome the customer cares about.',
    icon: 'Link',
    color: 'hsl(271, 76%, 53%)',
    isCore: true,
  },
  {
    ...
    category: 'engagement',
    description: 'Customer speaks appropriate amount (45-65% ideal), asks thoughtful questions, expresses interest in next steps, and maintains engagement.',
    showsUpWhen: 'Often shows up when the customer elaborates freely, asks detailed questions, and shows active interest.',
    examples: [
      'Balanced dialogue',
    ...
    calculation: 'WEIGHTED_AVG(customer_talk_time, customer_question_quality, forward_looking_cues, energy_shifts)',
    sampleIndicators: [
      'Balanced dialogue',
      'Customer seeks clarification',
      'Mentions "next steps" or "follow up"',
    ...
    keyTip: 'Create space for the customer to talk and notice when their energy shifts.',
    icon: 'Activity',
    color: 'hsl(24, 95%, 53%)',
    isCore: true,
  },
  {
    ...
    category: 'navigation',
    description: 'Acknowledges objection before responding, asks questions to understand root cause, and maintains composure and professionalism.',
    showsUpWhen: 'Often shows up when a seller validates concerns, probes deeper, and stays calm under pressure.',
    examples: [
      'Says "I understand" before rebutting',
      'Probes deeper on objection',
      'Avoids defensive language',
    ],
    calculation: 'AVG(acknowledge_before_response, explore_underlying_concern, calm_demeanor)',
    sampleIndicators: [
      'Says "I understand" before rebutting',
      'Probes deeper on objection',
      'Avoids defensive language',
    ],
    keyTip: 'Acknowledge the concern first, then explore what is behind it.',
    icon: 'Shield',
    color: 'hsl(0, 84%, 60%)',
    isCore: true,
  },
  {
    ...
    category: 'management',
    description: 'Sets clear agenda at start, manages topic flow with smooth transitions, respects time constraints, and recaps key points near end.',
    showsUpWhen: 'Often shows up when a seller sets an agenda, uses transitions, and summarizes progress.',
    examples: [
    ...
    calculation: 'WEIGHTED_AVG(purpose_setting, topic_management, time_management, summarizing)',
    sampleIndicators: [
      'States meeting purpose early',
      'Uses transition phrases',
      'Acknowledges time limits',
    ...
    keyTip: 'Set an agenda early and summarize key points before closing.',
    icon: 'Map',
    color: 'hsl(221, 83%, 53%)',
    isCore: true,
  },
  {
    ...
    category: 'commitment',
    description: 'Proposes concrete, specific next steps, gains explicit customer agreement, and clarifies who does what.',
    showsUpWhen: 'Often shows up when a seller proposes specific actions, confirms alignment, and defines roles clearly.',
    examples: [
      'Includes dates/times',
      'Customer says "yes" or "sounds good"',
      'States "I\'ll send..."',
    ],
    calculation: 'WEIGHTED_AVG(next_step_specificity, mutual_agreement, ownership_clarity)',
    sampleIndicators: [
      'Includes dates/times',
      'Customer says "yes" or "sounds good"',
      'States "I\'ll send..."',
    ],
    keyTip: 'Propose specific next steps and confirm who does what.',
    icon: 'CheckCircle',
    color: 'hsl(142, 71%, 45%)',
    isCore: true,
  },
  {
    ...
    category: 'adaptation',
    description: 'Changes strategy when needed, adjusts tone to match customer mood, adjusts detail level appropriately, and adjusts conversation pace.',
    showsUpWhen: 'Often shows up when a seller pivots after resistance, shows empathy, simplifies when confused, or speeds up when time-limited.',
    examples: [
    ...
    calculation: 'AVG(approach_shift, tone_adjustment, depth_adjustment, pacing_adjustment)',
    sampleIndicators: [
      'Pivots after resistance',
      'Becomes calmer when needed',
      'Simplifies when confused',
    ...
    keyTip: 'Stay flexible and adjust your approach when something is not working.',
    icon: 'Shuffle',
    color: 'hsl(173, 58%, 39%)',
    isCore: true,
  },
