...
export const behavioralMetrics: SignalCapability[] = [
  {
    ...
    behavioralMetric: 'Question Quality',
    category: 'awareness',
    description: 'Asking questions that are open, relevant, logically sequenced, and probe deeper to build understanding.',
    showsUpWhen: 'Questions reflect customer priorities, flow naturally, and encourage elaboration.',
    examples: [
    ...
    whatItMeasures: 'Quality of questioning approach: open vs. closed ratio, relevance to goals, logical sequencing, and follow-up depth.',
    whatStrongPerformanceLooksLike: [
      'High ratio of open questions',
      'Questions align with customer priorities',
      'Smooth topic transitions',
      'Probes deeper on customer responses',
    ],
    observableBehaviors: [
      'Open-ended questions dominate',
      'References prior customer statements',
      'Uses transition phrases',
      'Asks follow-up questions',
    ],
    whyItMatters: 'Quality questions drive discovery, build trust, and uncover customer needs.',
    coachingInsight: [
      'Low open/closed ratio → coach question types',
      'Poor relevance → coach active listening',
    ],
  ...
  },
  {
    ...
    behavioralMetric: 'Listening & Responsiveness',
    category: 'interpretation',
    description: 'Reflecting back customer statements, acknowledging concerns, and adjusting to new information.',
    showsUpWhen: 'Rep paraphrases, validates concerns, and adapts approach based on customer input.',
    examples: [
      'Uses "what I\'m hearing is..."',
      'Acknowledges concerns before responding',
      'Incorporates new details into discussion',
      'Adjusts approach when customer shares new information',
    ],
    whatItMeasures: 'How well the rep listens and responds: paraphrasing, concern acknowledgment, and adjustment to new information.',
    whatStrongPerformanceLooksLike: [
      'Frequent paraphrasing',
      'Concerns acknowledged promptly',
      'Adapts to new information',
    ],
    observableBehaviors: [
      'Reflects back customer points',
      'Says "I hear you" or "I understand"',
      'References newly shared information',
    ],
    whyItMatters: 'Active listening builds trust and ensures alignment with customer reality.',
    coachingInsight: [
      'Low paraphrasing → coach reflection skills',
      'Missed concerns → coach empathy',
    ],
    icon: 'Ear',
    color: 'hsl(142, 76%, 36%)',
    isCore: true,
  },
  {
    ...
    category: 'engagement',
    description: 'Connecting value to customer priorities using outcome-based language and avoiding feature dumps.',
    showsUpWhen: 'Rep uses "so that", "which means", references customer goals, and connects features to benefits.',
    examples: [
      'Uses "so that", "which means", "so you can"',
      'References customer-stated priorities',
      'Connects features to outcomes',
      'Avoids overwhelming feature lists',
    ],
    whatItMeasures: 'How well the rep connects value to customer priorities: outcome language, priority linkage, and avoiding feature dumps.',
    whatStrongPerformanceLooksLike: [
      'Outcome-focused language',
      'References customer goals',
      'Selective feature presentation',
    ],
    observableBehaviors: [
      'Uses outcome terms (improve, reduce, impact)',
      'Reuses customer language',
      'Connects each feature to benefit',
    ],
    whyItMatters: 'Value must be framed in customer terms to resonate and drive action.',
    coachingInsight: [
      'Feature dumping → coach selective presentation',
      'Weak linkage → coach customer language',
    ],
    icon: 'Target',
  ...
  },
  {
    ...
    category: 'engagement',
    description: 'Monitoring customer talk time, question quality, forward-looking cues, and energy shifts.',
    showsUpWhen: 'Customer speaks 45-65% of the time, asks thoughtful questions, mentions next steps, and maintains energy.',
    examples: [
      'Balanced dialogue (customer speaks 45-65%)',
      'Customer asks detailed questions',
      'Customer mentions "next steps" or "follow up"',
      'Energy remains positive',
    ],
    whatItMeasures: 'Customer engagement level: talk time balance, question quality, forward-looking cues, and energy shifts.',
    whatStrongPerformanceLooksLike: [
      'Customer speaks 45-65% of the time',
      'Customer asks 2+ questions',
      'Customer expresses interest in next steps',
      'Energy stable or increasing',
    ],
    observableBehaviors: [
      'Balanced dialogue',
      'Customer seeks clarification',
      'Customer proposes future actions',
      'Responses stay substantive',
    ],
    whyItMatters: 'Engagement signals reveal customer interest and readiness to move forward.',
    coachingInsight: [
      'Low talk time → coach question balance',
      'Energy drop → coach pacing',
    ],
    icon: 'Activity',
    color: 'hsl(45, 100%, 50%)',
    isCore: true,
  },
  {
    ...
    category: 'contextual',
    description: 'Acknowledging objections before responding, exploring underlying concerns, and maintaining composure.',
    showsUpWhen: 'Rep acknowledges objection, asks clarifying questions, and stays calm.',
    examples: [
    ...
    whatItMeasures: 'How well the rep handles objections: acknowledgment, exploration, and composure.',
    whatStrongPerformanceLooksLike: [
    ...
    observableBehaviors: [
      ...
      'Avoids immediate rebuttal',
    ],
    whyItMatters: 'Objections are opportunities to build trust and address real concerns.',
    coachingInsight: [
      'Defensive responses → coach composure',
      'Missed exploration → coach curiosity',
    ],
    icon: 'Shield',
    color: 'hsl(0, 70%, 50%)',
    isCore: true,
  },
  {
    ...
    behavioralMetric: 'Conversation Control & Structure',
    category: 'contextual',
    description: 'Setting agenda, managing topic flow, respecting time, and summarizing key points.',
    showsUpWhen: 'Rep sets clear agenda, uses transitions, adapts to time constraints, and recaps near end.',
    examples: [
    ...
    whatItMeasures: 'How well the rep manages conversation structure: agenda setting, topic management, time management, and summarizing.',
    whatStrongPerformanceLooksLike: [
      'Clear agenda early',
      'Smooth topic transitions',
    ...
    whyItMatters: 'Structure keeps conversations productive and respectful of customer time.',
    coachingInsight: [
      'Poor transitions → coach topic management',
      'No recap → coach summarization',
    ],
    icon: 'List',
    color: 'hsl(200, 70%, 50%)',
    isCore: true,
  },
  {
    ...
    behavioralMetric: 'Commitment Gaining',
    category: 'contextual',
    description: 'Proposing specific next steps, gaining explicit agreement, and clarifying ownership.',
    showsUpWhen: 'Rep proposes concrete actions with dates/times, customer agrees, and roles are clear.',
    examples: [
      'Includes dates/times in next steps',
      'Customer says "yes" or "sounds good"',
      'States "I\'ll send..." or "You\'ll review..."',
      'Defines roles clearly',
    ],
    whatItMeasures: 'How well the rep gains commitment: next step specificity, mutual agreement, and ownership clarity.',
    whatStrongPerformanceLooksLike: [
    ...
    whyItMatters: 'Clear commitments drive momentum and accountability.',
    coachingInsight: [
      'Vague next steps → coach specificity',
      'No agreement → coach confirmation',
    ],
    icon: 'Handshake',
    color: 'hsl(120, 70%, 50%)',
    isCore: true,
  },
  {
    ...
    behavioralMetric: 'Adaptability',
    category: 'contextual',
    description: 'Changing strategy, adjusting tone, modifying detail level, and adapting pace based on customer cues.',
    showsUpWhen: 'Rep pivots after resistance, matches customer mood, adjusts detail appropriately, and adapts pace.',
    examples: [
    ...
    whatItMeasures: 'How well the rep adapts: approach shifts, tone adjustment, depth adjustment, and pacing adjustment.',
    whatStrongPerformanceLooksLike: [
      'Changes strategy after resistance',
      'Matches customer energy',
      'Adjusts detail level',
      'Adapts conversation pace',
    ],
    observableBehaviors: [
      'Tries different angles',
      'Shows empathy appropriately',
      'Adds or reduces detail',
      'Matches customer pace',
    ],
    whyItMatters: 'Adaptability ensures the conversation meets the customer where they are.',
    coachingInsight: [
      'Rigid approach → coach flexibility',
      'Missed cues → coach awareness',
    ],
    icon: 'Zap',
    color: 'hsl(280, 70%, 50%)',
    isCore: true,
