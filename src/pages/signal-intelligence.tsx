      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold" data-testid="text-ei-metrics-title">Signal Intelligence™ Capabilities</h1>
          </div>
          <p className="text-muted-foreground">
            Signal Intelligence™ capabilities measure <strong>behavioral competencies</strong> through observable signals.
            Click any capability to view its definition, evaluation criteria, and coaching guidance.
          </p>
        </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium mb-1">Signal Intelligence™ Framework</p>
                <p className="text-sm text-muted-foreground">
                  Signal Intelligence™ measures <strong>behavioral competencies</strong>: how effectively you perceive observable signals, 
                  interpret them in context, and adapt your communication. Capabilities are scored 1-5 based on observable 
                  behaviors, not emotional states or personality traits.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                These capabilities form the foundation of behavioral measurement across all coaching experiences
              </p>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold">Additional Capabilities</h2>
              <p className="text-sm text-muted-foreground">
                Toggle capabilities on/off based on your coaching priorities
              </p>
            </div>
